...
function NoteItem({ note }: NoteItemProps) {
    ...
    return (
        <Link
            className={`text-text box-border flex h-8 items-center border-l-2 transition-[opacity,transform,background-color,border-color,padding-left] duration-base ease-out focus-visible:-outline-offset-2 ${
                isExiting
