...
function SearchBar({ value, onChange, ref }: SearchBarProps) {
    ...
    return (
        <div className="bg-bg border-border focus-within:border-accent hover:border-muted hover:focus-within:border-accent flex h-8 items-center gap-2 rounded border px-2.5 transition-colors duration-fast">
