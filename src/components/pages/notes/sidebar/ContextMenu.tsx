...
function ContextMenu({ note, position, onClose }: ContextMenuProps) {
    ...
    return (
        ...
        >
            <button
                className="text-ui-base text-muted hover:bg-accent-surface hover:text-text flex w-full items-center gap-2 rounded-sm px-2.5 py-1.5 transition-colors duration-fast"
            ...
            <button
                className={`text-ui-base relative flex w-full items-center justify-between overflow-hidden rounded-sm px-2.5 py-1.5 transition-colors duration-fast ${
